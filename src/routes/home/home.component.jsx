  ...
  return (
    <MainWrapper>
      ...
      >
        ...
        >
          <h1 className="description-text text-2xl md:text-4xl">
            Hey there! I am
          </h1>
          <h2 className="bold-header-text text-6xl tracking-normal md:text-8xl">
            Manu
            <span className="text-navy-blue-400">el Ser</span>
            afin Bugarin
          </h2>
          <p className="description-text text-xl py-2 px-0 md:w-[95%] md:text-3xl">
